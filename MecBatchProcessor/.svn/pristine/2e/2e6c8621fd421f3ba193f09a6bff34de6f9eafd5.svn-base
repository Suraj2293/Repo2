...
public class MultiEventCoreDTO implements Cloneable {
  ...
  public String toString() {
    return "MultiEventCoreDTO [threatId=" + threatId + ", eventTime=" + eventTime
        ...
        + ", others=" + others + ", customerName=" + customerName + ", customer=" + customer
        + ", severity=" + severity + ", sourceZone=" + sourceZone + ", destinationZone="
        + destinationZone + ", sourceGeoCountryName=" + sourceGeoCountryName
        + ", sourceGeoCityName=" + sourceGeoCityName + ", destGeoCountryName="
        + destinationGeoCountryName + ", destGeoCityName=" + destinationGeoCityName
        + ", recommendations=" + recommendations + ", ruleMatchDTOList=" + ruleMatchDTOList
        + ", ruleMatchDTO=" + ruleMatchDTO + ", ruleMatchIdList=" + ruleMatchIdList
        + ", matchedRuleName=" + matchedRuleName + ", matchedRuleId=" + matchedRuleId
