...
@Slf4j
public class TestBedFirstStep implements Serializable {
	private final Properties clientProp;

	public TestBedFirstStep(Properties clientProp1) {
		super();
		clientProp = clientProp1;
	}

	public JavaRDD<MultiEventCoreDTO> tranform(JavaRDD<TestBedDTO> rdd) {
		JavaRDD<MultiEventCoreDTO> rdd1 = rdd
				.mapPartitions(new FlatMapFunction<Iterator<TestBedDTO>, MultiEventCoreDTO>() {
					...
					public Iterator<MultiEventCoreDTO> call(
							Iterator<TestBedDTO> t) throws Exception {
